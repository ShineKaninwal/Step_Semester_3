...
📝 Week 05 - Practice Problems

The Week 05 practice problems focus on Java Object-Oriented Programming concepts and practical class-based problem solving.

1. Movie Ticket Access Check

File:

M1_MovieTicketAccessCheck.java

2. Subclass Ticket Access

File:

M2_SubclassTicketAccess.java

3. Seat Booking Encapsulation

File:

M3_SeatBookingEncapsulation.java

4. Movie Booking Profile

File:

M4_MovieBookingProfile.java

5. Booking Receipt Settlement

File:

M5_BookingReceiptSettlement.java

📌 Week 05 - Assignment

The Week 05 assignment contains Java OOP-based problems involving classes, objects, access control, and practical problem-solving.

1. Membership Field Record

File:

A1_MembershipFieldRecord.java

2. Reference Desk Subclass

File:

A2_ReferenceDeskSubclass.java

3. Book Copy Circulation

File:

A3_BookCopyCirculation.java

4. Library Member

File:

A4_LibraryMember.java

5. Loan Receipt Ledger

File:

A5_LoanReceiptLedger.java
